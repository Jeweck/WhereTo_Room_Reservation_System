  ...
  return (
    <div className="min-h-screen bg-primary flex flex-col items-center justify-center p-4">
      <div className="mb-8 text-center space-y-4 animate-in fade-in slide-in-from-top-4 duration-700">
        <div className="w-20 h-20 bg-white rounded-[22%] mx-auto flex items-center justify-center shadow-2xl">
          <svg
            width="48"
            height="48"
            viewBox="0 0 24 24"
      ...
      <Card className="w-full max-w-md border-none shadow-2xl overflow-hidden animate-in zoom-in-95 duration-500">
        ...
        <CardContent className="space-y-4">
          ...
          <Button 
            variant="outline" 
            className="w-full h-12 border-muted-foreground/20 hover:bg-accent shadow-sm" 
